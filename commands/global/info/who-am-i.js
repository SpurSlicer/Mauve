...
const { reply, getUserInfoJson } = require (`../../../src/helpers/discord_helper`);
	...
	access: generateAccessor(async (client, guild) => {
		...
		const data = [{
			...
			data: new SlashCommandBuilder()
				...
				.setDescription(`See general discord information about your account.`),
				async execute(interaction) {
					try {
						await reply(interaction, { content: getPrettyJsonText(getUserInfoJson(interaction), interaction, false, null, true) });
